...
pub(crate) const ONE_ATMOSPHERE: f64 = 101.325;

/// The temperature of space, in Kelvin
pub(crate) const TCMB: f64 = 2.725;

/// 0 degrees Celsius, in Kelvin
pub(crate) const T0C: f64 = 273.15;

/// 20 degrees Celsius, in Kelvin
pub(crate) const T20C: f64 = T0C + 20.0;
...
pub(crate) const WIND_ACCELERATION: f64 = 0.05;

/// Controls how quickly the wind spreads from tile to tile.
/// [0.0, f64::INFINITY]
pub(crate) const WIND_SPEED: f64 = 0.5;

/// A hard cap on how strong wind can become.
/// [0.0, f64::INFINITY]
pub(crate) const MAX_WIND: f64 = f64::INFINITY;

/// How fast should temperature flow?
/// [0.0, f64::INFINITY]
pub(crate) const TEMPERATURE_FLOW_RATE: f64 = 0.2;

/// Direct multiplier on strength of wind reported to BYOND.
/// [0.0, f64::INFINITY]
pub(crate) const BYOND_WIND_MULTIPLIER: f64 = 0.5;
...
pub(crate) const MINIMUM_TEMPERATURE_FOR_PRESSURE: f64 = 1.0;
